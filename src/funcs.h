...
#define CFG_TEXTBOX_FONT_SIZE 14
/* this one can be decreased by application if screen isn't large enought */
#define CFG_BUTTON_FONT_SIZE 20

/* helpers macro */
#define F_FULL(name, w1, w2, w3, w4, w5, w6,  pos) {name, {w1,w2,w3,w4,w5,w6},pos}
#define F_SIMPLE(name) {name,{name,"","","","",""}, 0}
#define F_1W(name, w1) {name, {w1,"","","","",""}, 0}
#define F_2W(name, w1, w2) {name, {w1, w2,"","",""}, 0}
#define F_3W(name, w1, w2, w3) {name, {w1,w2,w3,"","",""}, 1}
#define F_SEP {"",{"","","","","",""},0}
#define F_BR(name,func) {name,{func,"(",")","","",""}, 1}
